...
SYSTEM_ACCOUNTS=(lemonade.c led.ram led.ramfee led.stake led.bpay led.cpay led.vpay led.names led.saving led.rex led.msig led.bios led.wrap led.forum led.btc led.eth led.eos)
...
./cleos.sh push action led init '[0, "4,LED"]' -p led ## system initialized
## ===
